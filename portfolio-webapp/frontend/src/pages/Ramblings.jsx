        ...
        <div className="container">
          ...
          >
            ...
            <div style={{ 
              ...
              {[
                { mood: 'caffeinated',   icon: <Coffee size={18} />,   label: 'Caffeinated' },
                { mood: 'contemplative', icon: <Moon size={18} />,     label: 'Contemplative' },
                { mood: 'peaceful',      icon: <Sun size={18} />,      label: 'Peaceful' },
                { mood: 'nostalgic',     icon: <Heart size={18} />,    label: 'Nostalgic' },
                { mood: 'observant',     icon: <Eye size={18} />,      label: 'Observant' },
                { mood: 'inspired',      icon: <Lightbulb size={18} />, label: 'Inspired' },
              ].map(({ mood, icon, label }) => (
                <div key={mood} style={{
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  background: 'var(--bg-elevated)',
                  borderRadius: '8px',
                  border: `1px solid ${getMoodColor(mood)}33`,
                  justifyContent: 'center',
