...
const Contact = () => {
  ...
  const [availability, setAvailability] = useState('Available for meetups');

  useEffect(() => {
    axios.get('/api/profile')
      .then(r => { if (r.data.availability) setAvailability(r.data.availability); })
      .catch(() => {});
  }, []);
        ...
        <div className="container">
          ...
          >
            ...
            <p className="section-subtitle">
              Let's discuss data science, AI innovations, or grab a coffee in Gurugram
            </p>
          </motion.div>
            ...
            >
              ...
              <div style={{ marginBottom: '3rem' }}>
                ...
                <p style={{ 
                  ...
                  Whether you're looking for a data engineering consultant, want to explore research
                  collaborations, or just want to grab a coffee at one of Gurugram's amazing cafes,
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              ...
              >
                ...
                <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                  ...
                  Gurugram has some great spots to catch up over coffee — let's grab one and discuss ideas!
                </p>
              </motion.div>
